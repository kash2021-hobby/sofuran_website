...
import { Sparkles, ArrowRight, Trophy, BookOpen, Brain, Calculator, FlaskConical, Globe, Award, Heart, Rocket, Star, CheckCircle, ChevronDown } from "lucide-react";
...
const FAQ_DATA = [
  ...
  { q: "How are scholarships awarded?", en: "Scholarships are awarded based on examination performance. Top-performing students receive scholarships ranging from ₹500 to ₹20,000 along with merit certificates.", as: "পৰীক্ষাৰ ফলাফলৰ ভিত্তিত বৃত্তি প্ৰদান কৰা হয়। শীৰ্ষ স্থানীয় শিক্ষাৰ্থীসকলে ₹৫০০ৰ পৰা ₹২০,০০০ লৈকে বৃত্তি আৰু মেৰিট প্ৰমাণপত্ৰ লাভ কৰে।" },
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="mt-5 max-w-xl text-lg leading-relaxed text-gray-600 font-body">
                {t(
                  "Join thousands of students across Assam in the Sofura Talent Discovery & Scholarship Examination. Showcase your talent, earn statewide recognition, and compete for scholarships worth up to ₹5,000 while building confidence for future academic success.",
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link to="/contact" className="btn-bounce inline-flex items-center gap-2 rounded-full bg-[#FF6B6B] px-8 py-4 font-play text-lg font-bold text-white shadow-coral transition hover:bg-[#ff5252]">
                  <Trophy className="h-5 w-5" /> {t("Apply Now", "এতিয়াই আবেদন কৰক")}
                </Link>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <div className="flex items-center gap-2 rounded-full bg-[#FFD93D]/15 px-4 py-2">
                  <span className="font-play text-sm font-bold text-[#FF9F45]">🏆 {t("Scholarships up to ₹5,000", "বৃত্তি ₹৫,০০০ লৈকে")}</span>
                </div>
                <div className="flex items-center gap-2 rounded-full bg-[#FFD93D]/15 px-4 py-2">
          ...
          <div className="mt-14 grid items-start gap-10 md:grid-cols-2">
            ...
            <div>
              <div className="grid gap-4">
                <div className="card-tilt rounded-[2rem] bg-gradient-to-br from-[#FFD93D]/20 to-[#FF9F45]/10 p-6 shadow-md border border-[#FFD93D]/30">
                  <div className="flex items-center gap-4">
                    <span className="text-5xl">🏆</span>
                    <div>
                      <h3 className="font-play text-2xl font-bold text-white">{t("First Prize", "প্ৰথম পুৰস্কাৰ")}</h3>
                      <p className="font-play text-lg font-bold text-[#FFD93D]">{t("₹5,000 Scholarship", "₹৫,০০০ বৃত্তি")}</p>
                    </div>
                  </div>
                </div>
                <div className="card-tilt rounded-[2rem] bg-gradient-to-br from-[#4ECDC4]/20 to-[#4ECDC4]/5 p-6 shadow-md border border-[#4ECDC4]/30">
                  <div className="flex items-center gap-4">
                    <span className="text-5xl">🥈</span>
                    <div>
                      <h3 className="font-play text-2xl font-bold text-white">{t("Second Prize", "দ্বিতীয় পুৰস্কাৰ")}</h3>
                      <p className="font-play text-lg font-bold text-[#4ECDC4]">{t("₹3,000 Scholarship", "₹৩,০০০ বৃত্তি")}</p>
                    </div>
                  </div>
                </div>
                <div className="card-tilt rounded-[2rem] bg-gradient-to-br from-[#FF6B6B]/20 to-[#FF6B6B]/5 p-6 shadow-md border border-[#FF6B6B]/30">
                  <div className="flex items-center gap-4">
                    <span className="text-5xl">🥉</span>
                    <div>
                      <h3 className="font-play text-2xl font-bold text-white">{t("Third Prize", "তৃতীয় পুৰস্কাৰ")}</h3>
                      <p className="font-play text-lg font-bold text-[#FF6B6B]">{t("₹2,000 Scholarship", "₹২,০০০ বৃত্তি")}</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-6 flex flex-wrap gap-3">
                <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2">
                  <span className="font-play text-sm font-bold text-[#FFD93D]">📜 {t("Merit Certificates", "মেৰিট প্ৰমাণপত্ৰ")}</span>
                </div>
                <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2">
                  <span className="font-play text-sm font-bold text-[#4ECDC4]">🎖 {t("Academic Recognition", "শৈক্ষিক স্বীকৃতি")}</span>
                </div>
                <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2">
                  <span className="font-play text-sm font-bold text-[#FF9F45]">⭐ {t("Statewide Achievement", "ৰাজ্যিক সাফল্য")}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="relative">
                ...
                <div className="relative rounded-[2rem] bg-gradient-to-br from-[#FFF8E7]/10 to-[#FFD93D]/5 p-8 shadow-warm border border-[#FFD93D]/20 min-h-[320px] flex flex-col items-center justify-center">
                  <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[2rem]" aria-hidden="true">
                    <span className="absolute left-[8%] top-[10%] text-2xl animate-float" style={{ animationDelay: "0s" }}>🏆</span>
                    <span className="absolute right-[10%] top-[8%] text-2xl animate-float" style={{ animationDelay: "1s" }}>🎖</span>
                    <span className="absolute left-[5%] bottom-[20%] text-xl animate-float" style={{ animationDelay: "2s" }}>📜</span>
                    <span className="absolute right-[8%] bottom-[15%] text-xl animate-float" style={{ animationDelay: "0.5s" }}>⭐</span>
                    <span className="absolute left-[30%] top-[70%] text-lg animate-twinkle">🎓</span>
                    <span className="absolute right-[20%] top-[60%] text-lg animate-twinkle" style={{ animationDelay: "1.5s" }}>✨</span>
                  </div>
                  <Award className="h-16 w-16 text-[#FFD93D] mb-4 opacity-60" />
                  <p className="font-play text-xl font-bold text-white/80 text-center">
                    {t("Dr. Ranoj Pegu Award Distribution Ceremony", "ড০ ৰণোজ পেগু বিতৰণী অনুষ্ঠান")}
                  </p>
                  <p className="mt-2 max-w-xs text-center font-body text-sm text-white/50">
                    {t(
                      "Award ceremony photographs featuring Dr. Ranoj Pegu, Hon'ble Education Minister of Assam, presenting scholarships, certificates, and awards to outstanding students.",
                      "অসমৰ মাননীয় শিক্ষামন্ত্ৰী ড০ ৰণোজ পেগুৰ দ্বাৰা বিশিষ্ট শিক্ষাৰ্থীসকললৈ বৃত্তি, প্ৰমাণপত্ৰ আৰু পুৰস্কাৰ প্ৰদানৰ ছবি।"
                    )}
                  </p>
                </div>
              </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#FFD93D] via-[#FF9F45] to-[#FF6B6B]">
        ...
        <div className="mx-auto max-w-4xl px-4 py-20 text-center md:px-6 md:py-28">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link to="/contact" className="btn-bounce inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 font-play text-lg font-bold text-[#FF6B6B] shadow-lg transition hover:bg-[#FFF8E7]">
              <Trophy className="h-5 w-5" /> {t("Apply Now", "এতিয়াই আবেদন কৰক")}
            </Link>
