...
import { Sparkles, ArrowRight, Quote, Stars, BookOpen, Trophy, Award, Rocket, Heart } from "lucide-react";
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div className="relative">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link to="/exam" className="btn-bounce inline-flex items-center gap-2 rounded-full bg-[#FF6B6B] px-8 py-4 font-play text-lg font-bold text-white shadow-coral transition hover:bg-[#ff5252]">
                  📝 {t("Register for 2026", "২০২৬ৰ বাবে পঞ্জীয়ন")}
                </Link>
                <Link to="/magazine" className="btn-bounce inline-flex items-center gap-2 rounded-full border-2 border-[#FFD93D] bg-white px-8 py-4 font-play text-lg font-bold text-[#1A2A5E] transition hover:border-[#FF9F45] hover:bg-[#FFF8E7]">
            ...
            <div className="card-tilt group relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[#FFD93D] to-[#FF9F45] p-1 shadow-warm">
              <div className="rounded-[calc(2.5rem-4px)] bg-white p-6 md:p-8 flex flex-col min-h-[400px]">
                ...
                <div className="mt-auto pt-6">
                  <Link to="/magazine" className="btn-bounce inline-flex items-center gap-2 rounded-full bg-[#FF9F45] px-7 py-3.5 font-play text-base font-bold text-white shadow-md transition hover:bg-[#FF6B6B]">
                    {t("Submit Your Work", "আপোনাৰ কাম দাখিল কৰক")} <ArrowRight className="h-4 w-4" />
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="card-tilt group relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[#FF6B6B] to-[#4ECDC4] p-1 shadow-coral">
              <div className="rounded-[calc(2.5rem-4px)] bg-white p-6 md:p-8 flex flex-col min-h-[400px]">
                ...
                <ul className="mt-3 space-y-2">
                  {[
                    { icon: "🏆", text: t("Scholarships Up To ₹5,000", "বৃত্তি ₹৫,০০০ লৈকে") },
        ...
        <div className="mx-auto max-w-7xl px-4 py-24 md:px-6">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            <div className="card-tilt rounded-[2rem] bg-gradient-to-br from-[#FFD93D]/20 to-[#FF9F45]/10 p-6 shadow-md text-center border border-[#FFD93D]/30 md:p-8">
              ...
              <p className="mt-2 font-play text-3xl font-bold text-[#FF9F45]">{t("₹5,000 Scholarship", "₹৫,০০০ বৃত্তি")}</p>
            ...
            <div className="card-tilt rounded-[2rem] bg-gradient-to-br from-[#4ECDC4]/20 to-[#4ECDC4]/5 p-6 shadow-md text-center border border-[#4ECDC4]/30 md:p-8">
              ...
              <p className="mt-2 font-play text-3xl font-bold text-[#4ECDC4]">{t("₹3,000 Scholarship", "₹৩,০০০ বৃত্তি")}</p>
            ...
            <div className="card-tilt rounded-[2rem] bg-gradient-to-br from-[#FF6B6B]/20 to-[#FF6B6B]/5 p-6 shadow-md text-center border border-[#FF6B6B]/30 md:p-8">
              ...
              <p className="mt-2 font-play text-3xl font-bold text-[#FF6B6B]">{t("₹2,000 Scholarship", "₹২,০০০ বৃত্তি")}</p>
